    ...
    <section className="bg-cream">
      <div className="max-w-screen-2xl m-auto">
        <div className="flex justify-center flex-col md:px-16 md:pb-20 gap-2 md:gap-6">
          ...
          <article className="py-9 mb-24 text-[18px] md:text-[24px] m-auto px-6 md:px-10 flex flex-col gap-12 text-gray font-nunito">
            <p
              style={{
                lineHeight: "120%",
            ...
            <div>
              ...
              >
                <li>
                  {t("bullet1")}{" "}
                  <a className="underline" href="https://wa.me/628111329911">
                    WhatsApp
                  </a>
                  .
                </li>
