          ...
          <article className="w-11/12 md:w-full py-8 mb-12 md:mb-24 text-[24px] m-auto md:px-10 flex flex-col gap-10 md:gap-20 text-gray font-nunito">
            <div>
              <p
                ...
                className="mb-4 md:mb-10 font-quicksand font-bold text-darkpurple text-3xl md:text-[56px]"
              >
                Sustainability
              </p>
              <div
            ...
            <p
              className="text-justify text-gray font-nunito text-base md:text-2xl"
            ...
            <div className="flex flex-col gap-4 md:gap-5 items-start">
              ...
              <p
                className="text-gray font-nunito text-base md:text-2xl text-justify"
                style={{ whiteSpace: "pre-wrap" }}
              >
                {t("background")}
              </p>
              <p className="text-gray font-nunito text-base md:text-2xl text-justify py-1">
                {t("text")}
              </p>
            </div>
          </article>
