    ...
    <Accordion theme={accordion.root}>
      <Accordion.Panel theme={accordion}>
        ...
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a1")}</p>
        </Accordion.Content>
      </Accordion.Panel>
      <Accordion.Panel theme={accordion}>
        <Accordion.Title theme={accordion.title}>{t("q2")}</Accordion.Title>
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a2")}</p>
        </Accordion.Content>
      </Accordion.Panel>
      <Accordion.Panel theme={accordion}>
        <Accordion.Title theme={accordion.title}>{t("q3")}</Accordion.Title>
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a3")}</p>
          <br />
          <a
      ...
      <Accordion.Panel theme={accordion}>
        <Accordion.Title theme={accordion.title}>
          {t("table.q")}
        </Accordion.Title>
        <Accordion.Content theme={accordion.content}>
          ...
          <table className="mt-6 w-full border-collapse border border-gray-300">
            <thead>
              <tr className="bg-nude">
                <th className="border border-gray-300 px-2 md:px-4 py-2 w-1/6 text-center">
                  {t("table.theads.variant")}
                </th>
                <th className="border border-gray-300 px-2 md:px-4 py-2 w-1/6 text-center">
                  {t("table.theads.length")}
                </th>
                <th className="border border-gray-300 px-2 md:px-4 py-2 w-4/6 text-center">
                  {t("table.theads.description")}
                </th>
              </tr>
            </thead>
            <tbody className="text-gray text-base md:text-lg">
              <tr className="">
                <td className="border border-gray-300 px-2 md:px-4 py-3 text-center">
                  Maxi
                </td>
                <td className="border border-gray-300 px-2 md:px-4 py-3 text-center">
                  42 cm
      ...
      <Accordion.Panel theme={accordion}>
        ...
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a4")}</p>
        </Accordion.Content>
      </Accordion.Panel>
      <Accordion.Panel theme={accordion}>
        <Accordion.Title theme={accordion.title}>{t("q5")}</Accordion.Title>
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a5")}</p>
          <br />
          <a
            className="text-semibold text-darkpurple underline capitalize"
      ...
      <Accordion.Panel theme={accordion}>
        ...
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a6")}</p>
        </Accordion.Content>
      </Accordion.Panel>
      <Accordion.Panel theme={accordion}>
        <Accordion.Title theme={accordion.title}>{t("q7")}</Accordion.Title>
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a7")}</p>
        </Accordion.Content>
      </Accordion.Panel>
      <Accordion.Panel theme={accordion}>
        <Accordion.Title theme={accordion.title}>{t("q8")}</Accordion.Title>
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a8")}</p>
        </Accordion.Content>
      </Accordion.Panel>
      <Accordion.Panel theme={accordion}>
        <Accordion.Title theme={accordion.title}>{t("q9")}</Accordion.Title>
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a9")}</p>
        </Accordion.Content>
      </Accordion.Panel>
      <Accordion.Panel theme={accordion}>
      ...
      <Accordion.Panel theme={accordion}>
        ...
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a11")}</p>
        </Accordion.Content>
      </Accordion.Panel>
      <Accordion.Panel theme={accordion}>
        <Accordion.Title theme={accordion.title}>{t("q12")}</Accordion.Title>
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a12")}</p>
        </Accordion.Content>
      </Accordion.Panel>
      <Accordion.Panel theme={accordion}>
      ...
      <Accordion.Panel theme={accordion}>
        ...
        <Accordion.Content theme={accordion.content}>
          <p className="whitespace-pre-wrap mb-2 text-gray">{t("a14")}</p>
        </Accordion.Content>
      </Accordion.Panel>
    </Accordion>
  );
