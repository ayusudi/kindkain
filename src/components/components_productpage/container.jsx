...
export default function Component() {
  ...
  return (
    <div className="pl-5 flex flex-col md:pb-20 pb-14  gap-8 pr-8 mt-6 md:mt-14 overflow-x-scroll">
      <p className="m-auto md:m-0 w-5/6 md:w-full text-3xl md:text-4xl text-center md:text-left font-[700] font-quicksand">
        Our Costumer Also Buy
      </p>
        ...
        {new Array(4).fill("").map((e, i) => {
          ...
          return (
            <div
              ...
              className="cursor-pointer w-[150px] md:w-[300px] mb-2 md:mb-0"
            >
              <div
              ...
              >
                <Image
                  ...
                  src={photo}
                  alt={
                    "Pembalut Kain & Menstrual Cup Untuk Kesehatan Wanita " +
                    title
                  }
                />
              </div>
              <p
                ...
                className="p-1 md:p-0 font-bold my-2 md:my-4 text-md md:text-[21px] font-nunito text-darktext"
              >
                {title}
              </p>
              <p className="p-1 md:p-0 text-base md:text-[21px] text-gray font-nunito text-sm ">
                IDR {price}
              </p>
            </div>
          );
