...
const intl = {
  ...
  inlineWrapper:
    "bg-white w-[85px] text-black rounded-full focus:outline-none focus:ring-0 font-medium text-sm px-5 py-2.5 text-center inline-flex items-center justify-between",
};
...
const shop = {
  ...
  inlineWrapper:
    "py-2.5 bg-darkpurple text-white hover:text-yellow rounded-full focus:outline-none focus:ring-0 font-medium text-sm px-5 text-center inline-flex items-center ",
};
const object = {
  root: {
    ...
    <>
      ...
      <div className="h-fit w-full bg-cream shadow-md z-10 sticky top-0 ">
        <Navbar
          theme={object}
          fluid
          className="max-w-[1440px] bg-cream  m-auto"
        >
          ...
          <Navbar.Collapse>
            <Navbar.Link as={Link} href="/" active>
              <p className="md:py-8 py-2.5 text-center font-nunito text-black hover:text-white md:hover:text-black md:hover:font-bold md:hover:text-darkpurple md:border-b-4 md:border-transparent md:hover:border-darkpurple hover:bg-darkpurple md:hover:bg-transparent">
                {t("About Us")}
              </p>
            </Navbar.Link>
            <Navbar.Link as={Link} href="/why-menstrual-pads-or-cups">
              <p className="md:py-8 py-2.5 text-center font-nunito text-black hover:text-white md:hover:text-black md:hover:font-bold md:hover:text-darkpurple md:border-b-4 md:border-transparent md:hover:border-darkpurple hover:bg-darkpurple md:hover:bg-transparent">
                {t("Why Menstrual Pads or Cups?")}
              </p>
            </Navbar.Link>
