      ...
      <div className="max-w-screen-2xl m-auto hidden p-6 md:px-14 md:py-16  md:flex flex-col gap-4">
        ...
        <div className="hidden md:flex justify-between items-between mt-2">
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <InstagramEmbed url="https://www.instagram.com/p/C06OgjWy1xy/" width={418} height={726} />
          </div>
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <InstagramEmbed url="https://www.instagram.com/p/C0F2G6Myn9B/" width={418} height={726} />
          </div>

          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <InstagramEmbed url="https://www.instagram.com/p/CzvPz_4SuFP/" width={418} height={726} />
          </div>
