            ...
            {data.map((e, i) => {
              return (
                <div key={i} className="cursor-pointer trending-slider__item  mx-auto md:px-2">
                  <div style={{ position: 'relative' }} className='aspect-[2/3] md:aspect-square flex flex-col rounded-lg animated-background bg-white shadow shadow-md overflow-hidden p-8 justify-between'>
