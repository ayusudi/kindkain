                      ...
                      <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/kindkain.id/" className="cursor-pointer w-10 h-10 bg-purplepale flex justify-center items-center rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18" fill="none">
                          <g clipPath="url(#clip0_211_1038)">
                            ...
                            <path d="M8.54031 4.73291C6.13892 4.73291 4.19067 6.75073 4.19067 9.2379C4.19067 11.7251 6.13892 13.7429 8.54031 13.7429C10.9417 13.7429 12.89 11.7251 12.89 9.2379C12.89 6.75073 10.9417 4.73291 8.54031 4.73291ZM8.54031 12.1601C6.98238 12.1601 5.71884 10.8515 5.71884 9.2379C5.71884 7.62432 6.98238 6.31565 8.54031 6.31565C10.0982 6.31565 11.3618 7.62432 11.3618 9.2379C11.3618 10.8515 10.0982 12.1601 8.54031 12.1601Z" fill="white" />
                            <path d="M14.0774 4.55479C14.0774 5.13718 13.621 5.60652 13.062 5.60652C12.4997 5.60652 12.0465 5.13376 12.0465 4.55479C12.0465 3.97239 12.503 3.50305 13.062 3.50305C13.621 3.50305 14.0774 3.97582 14.0774 4.55479Z" fill="white" />
                          </g>
                          <defs>
                            <clipPath id="clip0_211_1038">
                              <rect width="16.9355" height="17.5403" fill="white" transform="translate(0.0725708 0.467773)" />
                            </clipPath>
                          </defs>
                        </svg>
                      </a>
                      ...
                      <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/kindkain.id/" className="cursor-pointer w-14 h-14 bg-purplepale flex justify-center items-center rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="29" viewBox="0 0 28 29" fill="none">
                          <g clipPath="url(#clip0_211_182)">
                            ...
                            <path d="M23.1547 6.75718C23.1547 7.72007 22.4 8.49605 21.4758 8.49605C20.5461 8.49605 19.7969 7.71441 19.7969 6.75718C19.7969 5.79429 20.5516 5.01831 21.4758 5.01831C22.4 5.01831 23.1547 5.79995 23.1547 6.75718Z" fill="white" />
                          </g>
                          <defs>
